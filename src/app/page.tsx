    ...
    <FinancialProvider>
      <div className="h-screen flex flex-col bg-slate-100/50">
        ...
        <header className="bg-white shadow-sm border-b">
            <div className="container mx-auto px-4 px-safe py-3 flex flex-col items-center justify-center">
                <h1 className="text-lg font-black text-slate-800 tracking-tighter uppercase mb-2">Planejamento<span className="text-blue-600">Financeiro</span></h1>
